...
\section{个人总结}
\begin{itemize}
    \item 拥有8年异构平台（CPU/GPU/DSP/NPU）算子加速库开发经验，专注 BLAS，DNN 等核心加速库的开发。
...
\ResumeItem{CUTLASS 移植} [掌握 CUTLASS 编程范式]
[2025.07 - 至今]
\begin{itemize}
    \item 预研分析 CUTLASS 框架，cute layout 算术，并支持新的芯片架构，初步实现泛化的 gemm 算子。
\end{itemize}
